-- =====================================================
-- ORCHARD RESET FIX v1
-- Usuwa "smart reset" z harvest_tree i harvest_all_trees.
-- Po zbiorze timer zawsze startuje od teraz (now),
-- nie przenosi nadwyżki z poprzedniego cyklu.
--
...
BEGIN
  ...
  -- Zawsze reset do teraz — timer startuje od 0 po każdym zbiorze
