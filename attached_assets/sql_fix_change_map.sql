-- Naprawa funkcji game_change_map
-- Dodaje farm5, farm10, farm15, farm20, farm25 do listy dozwolonych map
...
DECLARE
  v_uid  uuid := auth.uid();
  v_valid text[] := ARRAY[
    'farm1', 'farm5', 'farm10', 'farm15', 'farm20', 'farm25',
    'city', 'city_shop', 'city_market', 'city_bank', 'city_townhall'
  ];
  v_result jsonb;
BEGIN
