-- =====================================================
-- HIVE BONUSY z EKWIPUNKU — Plonopolis (Partia 2)
-- Uruchom raz w Supabase SQL Editor (CREATE OR REPLACE — bezpieczne)
-- =====================================================
-- Aktualizuje funkcję collect_honey aby przyjmowała 2 bonusy z eq:
...
BEGIN
  ...
  -- honey_start: liczone na bazie SUROWEGO miodu (nie pomnożonego)
  -- żeby bonus produkcji nie psuł cyklu czasowego ula
  v_new_hive := jsonb_build_object(
    ...
    'honey_start',     CASE
                         ...
                         THEN v_now_ms
                         ELSE v_honey_start + v_honey_avail_raw::bigint * v_ms_per_pt
                       END,
