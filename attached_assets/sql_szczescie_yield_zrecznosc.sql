-- ============================================================
-- AKTUALIZACJA: game_harvest_plot
-- Zmiany:
--   1. p_szczescie → wpływa na jakość plonów (good nasiono)
--   2. Losowy yield: lvl 1-6 (yieldAmount<=2) → 1-3 szt., lvl 7-25 → 2-5 szt.
--   3. Zręczność podwaja finalny yield (zamiast dodawać yield_amount)
...
begin
  ...
  if p_zrecznosc > 0 and random() < v_zrecznosc_chance then
    ...
    -- Podwaja cały zebrany plon (zamiast dodawać stały yield_amount)
