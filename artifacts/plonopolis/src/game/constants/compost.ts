...
export const COMPOST_DEFS: Record<CompostType, { id: string; name: string; icon: string; imgs: Record<number, string>; desc: string; descs: Record<number, string>; effectLabel: string; bonusValues: number[]; bonusLabel: (v: number) => string; tierName: (v: number) => string }> = {
  growth: { id: "compost_growth", name: "Kompost Wzrostu",      icon: "⚡", imgs: { 5: "/ekwipunek/kompost/kompost_wzrostu_slaby.webp",   10: "/ekwipunek/kompost/kompost_wzrostu_sredni.webp",   15: "/ekwipunek/kompost/kompost_wzrostu_mocny.webp"   }, desc: "Przyspiesza wzrost upraw",     descs: { 5: "Delikatnie pobudza rośliny do działania. Bez pośpiechu, ale skutecznie.", 10: "Rośliny po nim rosną szybciej, jakby ktoś szepnął im: czas na awans.", 15: "Potężna dawka energii dla upraw, które nie mają czasu na lenistwo." }, effectLabel: "⚡ Szybszy wzrost",   bonusValues: [5, 10, 15], bonusLabel: (v) => `-${v}% czasu wzrostu`, tierName: (v) => v <= 5 ? "Słaby" : v <= 10 ? "Średni" : "Mocny" },
  yield:  { id: "compost_yield",  name: "Kompost Urodzaju",     icon: "🌾", imgs: { 1: "/ekwipunek/kompost/kompost_urodzaju_slaby.webp",   2: "/ekwipunek/kompost/kompost_urodzaju_sredni.webp",   3: "/ekwipunek/kompost/kompost_urodzaju_mocny.webp"   }, desc: "Zwiększa plon przy zbiorze",   descs: { 1: "Skromna pomoc dla plonów, które chcą dać z siebie trochę więcej.", 2: "Ziemia go lubi, a koszyk zbieracza lubi go jeszcze bardziej.", 3: "Sprawia, że pole wygląda, jakby miało wyjątkowo dobry dzień." }, effectLabel: "🌾 Większy plon",     bonusValues: [1, 2, 3],   bonusLabel: (v) => `+${v} sztuk plonu`,    tierName: (v) => v <= 1 ? "Słaby" : v <= 2 ? "Średni" : "Mocny" },
  exp:    { id: "compost_exp",    name: "Kompost Nauki",        icon: "⭐", imgs: { 10: "/ekwipunek/kompost/kompost_nauki_slaby.webp",     20: "/ekwipunek/kompost/kompost_nauki_sredni.webp",     30: "/ekwipunek/kompost/kompost_nauki_mocny.webp"     }, desc: "Daje więcej EXP przy zbiorze", descs: { 10: "Trochę wiedzy z ziemi, trochę doświadczenia z pola.", 20: "Pomaga roślinom rosnąć, a farmerowi szybciej łapać doświadczenie.", 30: "Podobno nawet marchewki po nim wiedzą, co to progres." }, effectLabel: "⭐ Więcej EXP",       bonusValues: [10, 20, 30], bonusLabel: (v) => `+${v}% EXP`,           tierName: (v) => v <= 10 ? "Słaby" : v <= 20 ? "Średni" : "Mocny" },
  guide:  { id: "guide_compost",  name: "Kompost Przewodnika",  icon: "🌟", imgs: { 65: "/ekwipunek/kompost/kompost_przewodnika.webp"                                                                                   }, desc: "Specjalny kompost dla początkujących. Skraca czas wzrostu uprawy o 65% (globalny cap). Nie można go sprzedać na targu.", descs: { 65: "Specjalny kompost dla początkujących farmerów. Przewodnik mówi, że działa. Przekonamy się?" }, effectLabel: "🌟 −65% czasu wzrostu", bonusValues: [65], bonusLabel: () => `−65% czasu wzrostu`, tierName: () => "Kompost Przewodnika" },
};
