export const CUSTOMER_AVATARS: Record<string, string[]> = {
  ...
  "Gość":                 Array.from({ length: 12 }, (_, i) => `/klienci/customer_neighbor_${i + 1}.png`),
  "gosc":                 Array.from({ length: 12 }, (_, i) => `/klienci/customer_neighbor_${i + 1}.png`),
  "guest":                Array.from({ length: 12 }, (_, i) => `/klienci/customer_neighbor_${i + 1}.png`),
  "Sąsiad":               Array.from({ length: 12 }, (_, i) => `/klienci/customer_neighbor_${i + 1}.png`),
};
