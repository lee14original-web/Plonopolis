...
export default function Page() {
  ...
  <button
    ...
    title="Pola uprawne"
  >
    <div className="relative h-full w-full overflow-hidden rounded-[22px] border-2 border-[#d8ba7a]/70 bg-[rgba(28,18,10,0.10)] shadow-[0_0_30px_rgba(255,220,120,0.18)] backdrop-blur-sm">
