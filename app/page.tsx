...
const FARM_PLOTS: FarmPlot[] = Array.from({ length: 25 }, (_, index) => ({
  id: index + 1,
  left: "0%",
  top: "0%",
  width: "0%",
...
export default function Page() {
  ...
  function getMaxPlotsForLevel(level: number) {
    return Math.min(3 + Math.max(level - 1, 0), 25);
  }
              ...
              <div className="absolute left-4 top-16 z-20">
                <div className="rounded-[28px] border border-[#8b6a3e] bg-[rgba(38,24,14,0.82)] p-4 text-[#f3e6c8] shadow-2xl backdrop-blur-sm">
                  ...
                  <p className="mt-1 text-sm text-[#dfcfab]">
                    Pola: {Math.min(unlockedPlots, 25)} / {maxPlotsForLevel}
                  </p>
                    ...
                    <>
                      ...
                      <div className="mt-4 grid gap-2">
                        <button
                          ...
                          disabled={selectedPlotId! > Math.min(unlockedPlots, 25) || !!getPlotCrop(selectedPlotId!).cropId}
